...
struct WaylandWindow::Impl {
    ...
    Impl(int width, int height, const char* title) {
        ...
        if (m_type == Type::LayerSurface) {
            m_zwlr_layer_surface = zwlr_layer_shell_v1_get_layer_surface(m_zwlr_layer_shell, m_wl_surface, nullptr, ZWLR_LAYER_SHELL_V1_LAYER_BACKGROUND, title);
            ...
            zwlr_layer_surface_v1_set_anchor(m_zwlr_layer_surface, ZWLR_LAYER_SURFACE_V1_ANCHOR_RIGHT);
            zwlr_layer_surface_v1_set_margin(m_zwlr_layer_surface, 0, 300, 0, 0);
